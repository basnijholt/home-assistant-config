import{ds as e,cX as t,x as s,d6 as a,dC as r,dD as i,dE as o,dB as l,r as d,eV as n,_ as h,t as c,eK as u,eN as p,cT as y,a as m,cU as _,cY as f,n as v}from"./card-f2dccb12.js";import{c as g,e as $}from"./ha-hls-player-eb54930e.js";import{s as b,d as w,h as R,c as L}from"./media-b760b424.js";import{m as I}from"./audio-cf3a75aa.js";customElements.whenDefined("ha-web-rtc-player").then((()=>{let u=class extends(customElements.get("ha-web-rtc-player")){async play(){return this._video?.play()}async pause(){this._video?.pause()}async mute(){this._video&&(this._video.muted=!0)}async unmute(){this._video&&(this._video.muted=!1)}isMuted(){return this._video?.muted??!0}async seek(e){this._video&&(this._video.currentTime=e)}async setControls(e){this._video&&b(this._video,e??this.controls)}isPaused(){return this._video?.paused??!0}async getScreenshotURL(){return this._video?e(this._video):null}getFullscreenElement(){return this._video??null}render(){return this._error?(w(this),t({type:"error",message:this._error,context:{entity_id:this.entityid}})):s`
        <video
          ...
          @pause=${()=>o(this)}
        ></video>
      `}_loadedDataHandler(e){super._loadedData(),l(this,e,{player:this,capabilities:{supportsPause:!0,hasAudio:I(this._video)},technology:["webrtc"]})}static get styles(){return[super.styles,d(g),n`
          :host {
            width: 100%;
            height: 100%;
          }
        ...
        ></frigate-card-ha-hls-player>`:a.type===e?s`<frigate-card-ha-web-rtc-player
          ...
          class="player ${a.visible?"":"hidden"}"
        ></frigate-card-ha-web-rtc-player>`:u:u;var r}updated(e){super.updated(e);const t=this._streams(this._capabilities?.frontend_stream_types,this._hlsStreams,this._webRtcStreams).find((e=>e.visible))??null;if(t){const e=this._mediaLoadedInfoPerStream[t.type];e&&e!==this._mediaLoadedInfoDispatched&&(this._mediaLoadedInfoDispatched=e,y(this,e))}}static get styles(){return[super.styles,d(g),n`
          :host {
            width: 100%;
            height: 100%;
          }
      ...
      .muted=${!0}
    >
    </frigate-card-ha-camera-stream>`}static get styles(){return d(":host {\n  width: 100%;\n  height: 100%;\n  display: block;\n}")}};h([v({attribute:!1})],P.prototype,"hass",void 0),h([v({attribute:!1})],P.prototype,"cameraConfig",void 0),h([v({attribute:!0,type:Boolean})],P.prototype,"controls",void 0),P=h([c("frigate-card-live-ha")],P);export{P as FrigateCardLiveHA};
