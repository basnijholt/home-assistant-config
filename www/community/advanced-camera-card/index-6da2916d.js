import{_ as e,n as a,t as i,a as t,d2 as r,x as s,d4 as o,di as n,dj as d,dk as l,dl as c,da as h,r as g,b as m,dm as u,dd as v,dn as C,dp as p,dq as w,dr as M,ds as y,dt as I,du as _,de as f,d6 as b,dv as A,dw as j,dx as D,d0 as x,dy as T,s as E,d7 as k,d8 as $,a4 as L,l as N,db as z}from"./card-14af3f7e.js";import"./image-player-60309f73.js";import{M as S,i as P}from"./media-provider-dimensions-controller-ac121cec.js";import{L as Z,M as O,a as V,A as G}from"./dispatch-live-error-75368eb0.js";import{V as R,h as W,m as Y,M as B}from"./audio-938432b1.js";let U=class extends t{constructor(){super(...arguments),this.controls=!1,this._refVideo=r(),this._mediaPlayerController=new R(this,(()=>this._refVideo.value??null),(()=>this.controls))}async getMediaPlayerController(){return this._mediaPlayerController}render(){return s`
      <video
        ${o(this._refVideo)}
        muted
        playsinline
        ...
        @loadedmetadata=${e=>{e.target&&this.controls&&W(e.target,B)}}
        @loadeddata=${e=>{n(this,e,{...this._mediaPlayerController&&{mediaPlayerController:this._mediaPlayerController},capabilities:{supportsPause:!0,hasAudio:Y(e.target)},technology:["mp4"]})}}
        @volumechange=${()=>d(this)}
        @play=${()=>l(this)}
        @pause=${()=>c(this)}
      >
    ...
    </div>`}render(){if(this._lazyLoadController?.isLoaded()&&this.media&&this.hass&&this.viewerConfig)return this._url?this._renderContainer(s`
    ...
    `}updated(e){super.updated(e);(!!this._refCarousel.value&&this._mediaActionsController.setRoot(this._refCarousel.value)||e.has("viewManagerEpoch"))&&this._setMediaTarget(),e.has("viewManagerEpoch")&&this.viewManagerEpoch?.manager.getView()?.context?.mediaViewer!==this.viewManagerEpoch?.oldView?.context?.mediaViewer&&this._seekHandler()}_setMediaTarget(){this._media?.length&&null!==this._selected?(this._mediaActionsController.setTarget(this._selected,!this.viewFilterCameraID||this.viewManagerEpoch?.manager.getView()?.camera===this.viewFilterCameraID),this._mediaHeightController.setSelected(this._selected)):this._mediaActionsController.unsetTarget()}async _seekHandler(){const e=this.viewManagerEpoch?.manager.getView(),a=e?.context?.mediaViewer?.seek;if(!(this.hass&&a&&this._media&&this._loadedMediaPlayerController&&null!==this._selected))return;const i=this._media[this._selected];if(!i)return;const t=i.includesTime(a);E(this,!t,"unseekable"),t||this._loadedMediaPlayerController.isPaused()?t&&this._loadedMediaPlayerController.isPaused()&&this._loadedMediaPlayerController.play():this._loadedMediaPlayerController.pause();const r=await(this.cameraManager?.getMediaSeekTime(i,a))??null;null!==r&&this._loadedMediaPlayerController.seek(r)}_renderMediaItem(e){const a=this.viewManagerEpoch?.manager.getView();return this.hass&&a&&this.viewerConfig?s` <div class="embla__slide">
      ...
      ></advanced-camera-card-viewer-provider>
    </div>`:null}static get styles(){return g(":host {\n  display: block;\n  --video-max-height: none;\n  transition: max-height 0.1s ease-in-out;\n  position: relative;\n}\n\n:host(:not([grid-id])) {\n  height: 100%;\n}\n\n:host([unselected]) advanced-camera-card-carousel,\n:host([unselected]) .seek-warning {\n  pointer-events: none;\n}\n\n:host([unseekable]) advanced-camera-card-carousel {\n  filter: brightness(50%);\n}\n\n:host([unseekable]) .seek-warning {\n  display: block;\n}\n\n.seek-warning {\n  display: none;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translateX(-50%) translateY(-50%);\n  color: white;\n}\n\n.embla__slide {\n  display: flex;\n  height: 100%;\n  width: 100%;\n  flex: 0 0 100%;\n}")}};e([a({attribute:!1})],X.prototype,"hass",void 0),e([a({attribute:!1})],X.prototype,"viewManagerEpoch",void 0),e([a({attribute:!1})],X.prototype,"viewFilterCameraID",void 0),e([a({attribute:!1,hasChanged:D})],X.prototype,"viewerConfig",void 0),e([a({attribute:!1})],X.prototype,"resolvedMediaCache",void 0),e([a({attribute:!1})],X.prototype,"cardWideConfig",void 0),e([a({attribute:!1})],X.prototype,"cameraManager",void 0),e([a({attribute:!1})],X.prototype,"showControls",void 0),e([m()],X.prototype,"_selected",void 0),X=e([i("advanced-camera-card-viewer-carousel")],X);let H=class extends t{_renderCarousel(e){const a=this.viewManagerEpoch?.manager.getView()?.camera;return s`
    ...
    `:this._renderCarousel()}static get styles(){return g(z)}};e([a({attribute:!1})],H.prototype,"hass",void 0),e([a({attribute:!1})],H.prototype,"viewManagerEpoch",void 0),e([a({attribute:!1})],H.prototype,"viewerConfig",void 0),e([a({attribute:!1})],H.prototype,"resolvedMediaCache",void 0),e([a({attribute:!1})],H.prototype,"cardWideConfig",void 0),e([a({attribute:!1})],H.prototype,"cameraManager",void 0),H=e([i("advanced-camera-card-viewer-grid")],H);let Q=class extends t{constructor(){super(...arguments),this.isEmpty=!1}willUpdate(e){if(e.has("viewManagerEpoch")){const e=this.viewManagerEpoch?.manager.getView();this.isEmpty=!e?.queryResults?.getResults()?.filter((e=>u.isMedia(e))).length}}render(){if(this.hass&&this.viewManagerEpoch&&this.viewerConfig&&this.cameraManager&&this.cardWideConfig){if(this.isEmpty){const e=!!this.viewManagerEpoch.manager.getView()?.context?.loading?.query;return L({type:"info",message:N(e?"error.awaiting_media":"common.no_media"),icon:"mdi:multimedia",dotdotdot:e})}return s` <advanced-camera-card-viewer-grid
      .hass=${this.hass}
      .viewManagerEpoch=${this.viewManagerEpoch}
      .viewerConfig=${this.viewerConfig}
      .resolvedMediaCache=${this.resolvedMediaCache}
      ...
      .cardWideConfig=${this.cardWideConfig}
    >
    </advanced-camera-card-viewer-grid>`}}static get styles(){return g(":host {\n  width: 100%;\n  height: 100%;\n  display: flex;\n  flex-direction: column;\n  gap: 5px;\n}\n\n:host([empty]) {\n  aspect-ratio: 16/9;\n}\n\nadvanced-camera-card-viewer-carousel {\n  flex: 1;\n  min-height: 0;\n}")}};e([a({attribute:!1})],Q.prototype,"hass",void 0),e([a({attribute:!1})],Q.prototype,"viewManagerEpoch",void 0),e([a({attribute:!1})],Q.prototype,"viewerConfig",void 0),e([a({attribute:!1})],Q.prototype,"resolvedMediaCache",void 0),e([a({attribute:!1})],Q.prototype,"cameraManager",void 0),e([a({attribute:!1})],Q.prototype,"cardWideConfig",void 0),e([a({attribute:"empty",reflect:!0,type:Boolean})],Q.prototype,"isEmpty",void 0),Q=e([i("advanced-camera-card-viewer")],Q);export{Q as AdvancedCameraCardViewer};
