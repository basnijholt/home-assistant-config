import{_ as e,n as a,t as i,a as t,d2 as r,x as s,d4 as n,di as o,dj as d,dk as l,dl as c,da as h,r as g,b as m,dm as u,dd as v,dn as C,dp as p,dq as w,dr as M,ds as y,dt as I,du as _,de as f,d6 as b,dv as A,dw as j,dx as D,d0 as x,dy as T,s as E,d7 as k,d8 as $,a4 as L,l as N,db as z}from"./card-d84eb2c6.js";import"./image-player-a48c8b51.js";import{M as S,i as P}from"./media-provider-dimensions-controller-ded3f494.js";import{L as Z,M as O,a as V,A as G}from"./dispatch-live-error-cd92f1ac.js";import{V as R,h as W,m as Y,M as B}from"./audio-eb3b9f39.js";let U=class extends t{constructor(){super(...arguments),this.controls=!1,this._refVideo=r(),this._mediaPlayerController=new R(this,(()=>this._refVideo.value??null),(()=>this.controls))}async getMediaPlayerController(){return this._mediaPlayerController}render(){return s`
      <video
        ${n(this._refVideo)}
        muted
        playsinline
        ...
        @loadeddata=${e=>{o(this,e,{...this._mediaPlayerController&&{mediaPlayerController:this._mediaPlayerController},capabilities:{supportsPause:!0,hasAudio:Y(e.target)},technology:["mp4"]})}}
        @volumechange=${()=>d(this)}
        @play=${()=>l(this)}
        @pause=${()=>c(this)}
      >
