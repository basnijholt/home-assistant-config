import{dp as e,cX as t,x as s,d2 as a,dz as r,dA as i,dB as d,dy as o,r as n,eS as l,_ as h,t as c,eH as u,eK as p,cT as y,a as m,cU as _,cY as v,n as $}from"./card-e6d61164.js";import{c as f,e as g}from"./ha-hls-player-6f393e33.js";import{s as b,d as w,h as R,c as L}from"./media-0025868e.js";import{m as S}from"./audio-cf3a75aa.js";customElements.whenDefined("ha-web-rtc-player").then((()=>{let u=class extends(customElements.get("ha-web-rtc-player")){async play(){return this._video?.play()}async pause(){this._video?.pause()}async mute(){this._video&&(this._video.muted=!0)}async unmute(){this._video&&(this._video.muted=!1)}isMuted(){return this._video?.muted??!0}async seek(e){this._video&&(this._video.currentTime=e)}async setControls(e){this._video&&b(this._video,e??this.controls)}isPaused(){return this._video?.paused??!0}async getScreenshotURL(){return this._video?e(this._video):null}getFullscreenElement(){return this._video??null}render(){return this._error?(w(this),t({type:"error",message:this._error,context:{entity_id:this.entityid}})):s`
        <video
          ...
          @pause=${()=>d(this)}
        ></video>
      `}_loadedDataHandler(e){super._loadedData(),o(this,e,{player:this,capabilities:{supportsPause:!0,hasAudio:S(this._video)},technology:["webrtc"]})}static get styles(){return[super.styles,n(f),l`
          :host {
            width: 100%;
            height: 100%;
          }
      ...
      .muted=${!0}
    >
    </advanced-camera-card-ha-camera-stream>`}static get styles(){return n(":host {\n  width: 100%;\n  height: 100%;\n  display: block;\n}")}};h([$({attribute:!1})],I.prototype,"hass",void 0),h([$({attribute:!1})],I.prototype,"cameraConfig",void 0),h([$({attribute:!0,type:Boolean})],I.prototype,"controls",void 0),I=h([c("advanced-camera-card-live-ha")],I);export{I as AdvancedCameraCardLiveHA};
