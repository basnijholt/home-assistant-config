import{dd as e,d9 as a,dn as r,de as t,_ as n,n as s,t as o,a as i,x as l,e as d,dO as c,a4 as h,l as u,dP as m,r as g}from"./card-d64f0a1a.js";import"./gallery-core-0702a7bd.js";import"./endOfDay-53de131e.js";import"./parse-96d67644.js";import"./date-picker-594e63aa.js";class p{constructor(e){this._host=e}setThumbnailSize(a){this._host.style.setProperty("--advanced-camera-card-thumbnail-size",`${a??e}px`)}getColumnWidth(a){return a?a.show_details?200:a.size:e}getColumnCountRoundMethod(e){return e?.show_details?"floor":"ceil"}itemClickHandler(e,n,s){a(s);const o=e.getView();if(o)if(r.isMedia(n))e.setViewByParameters({params:{view:"media",queryResults:o.queryResults?.clone().selectResultIfFound((e=>e===n))}});else if(r.isFolder(n)&&t.isFolderQuery(o.query)){const a=o.query.getQuery(),r=n.getID();if(!a||!r)return;e.setViewByParametersWithExistingQuery({params:{query:o.query.clone().setQuery({folder:a.folder,path:[...a.path,{id:r}]})}})}}}let v=class extends i{constructor(){super(...arguments),this._controller=new p(this)}willUpdate(e){e.has("galleryConfig")&&this._controller.setThumbnailSize(this.galleryConfig?.controls.thumbnails.size)}_renderThumbnail(e,a,r){return l`<advanced-camera-card-thumbnail
      class=${d({selected:a})}
      .hass=${this.hass}
      .item=${e}
