        ...
        ${this._currentItem?n.length?r`
              <mwc-list multi @selected=${this._handleSelected}>
                ${b(n,(t=>t.media_content_id),(t=>{const e=r`
                      <ha-svg-icon
                        slot="graphic"
                        .path=${k["directory"===t.media_class&&t.children_media_class||t.media_class].icon}
                      ></ha-svg-icon>
                    `;return r`
                      <ha-check-list-item
